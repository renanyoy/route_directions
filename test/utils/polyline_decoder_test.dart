import 'package:route_directions/src/utils/polyline_decoder.dart';
import 'package:test/test.dart';
import 'package:route_directions/route_directions.dart';
  ...
  group('PolylineDecoder', () {
    ...
    test('should decode polyline with high precision coordinates', () {
      ...
      for (final point in decodedPoints) {
        ...
        expect(
            point.latitude, isNot(equals(point.latitude.round().toDouble())));
        expect(
            point.longitude, isNot(equals(point.longitude.round().toDouble())));
      }
    });
